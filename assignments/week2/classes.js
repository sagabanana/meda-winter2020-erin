...
class Car {
    ...
    checkFuel() {
        console.log(`The car ${this.make} ${this.model} has ${this.currentFuelGallons} gallons of gas left in this tank.`);
    }
    ...
    refuel(gallons) {
        if (typeof gallons === "number") {
            ...
            console.log("Refuel sucessful, added " + gallons + " to the tank.");
        } else {
